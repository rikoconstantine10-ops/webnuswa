  ...
  return (
    <div>
      <PageHeader
        ...
        description="Buat video showcase produk dari 1 foto HP pakai AI."
        action={
          enabled ? (
            <Link
      ...
      {!enabled ? (
        <EmptyState
          ...
          description="Hubungi admin platform untuk mengaktifkan generate video AI di tokomu."
        />
      ) : (
        <AiStudioVideoPanel products={products} />
      )}
    </div>
  );
}
